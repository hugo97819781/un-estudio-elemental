...
Todo espacio metrizable, compacto y separable $X$ es $1\AN$, por tanto es de Fréchet. Además $X$ es secuencialmente compacto (\textcolor{red}{Prelim}), consecuentemente, cualquier denso numerable $D$, de $X$, tiene el comportamiento del inciso (i) del Corolario previo. Se demuestra entonces la consecuencia:
