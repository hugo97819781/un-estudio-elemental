...
El comentario anterior deja como consecuencia la falsedad de que cualquier familia casi ajena sea esencialmente igual (en el sentido de la \autoref{Dif-esencial}) a alguna de las definidas en \ref{def-FamRamas}; de lo contrario, cualquier espacio espacio de Isbell-Mrówka de tamaño menor al continuo sería es normal, cosa que es falsa, en $\zfc$.