...
El cubo de Hilbert, $[0,1]^\omega$, contiene una copia homeomorfa de todos los espacios metrizables y separables (véase \ref{cubo-Hilbert-encaje}) y todos sus subespacios son metrizables y separables. Así que tanto él, como todos sus subespacios compactos, son imágen continua de algún espacio de Mrówka generado por una familia casi ajena maximal. En lo anterior caben: el conjunto de cantor $2^\omega$, el intervalo $[0,1]$, todo \textit{continuo} (todo espacio $X$ no vacío, metrizable, compacto y conexo), por mencionar algunos.
