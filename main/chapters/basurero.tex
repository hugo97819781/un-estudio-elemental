...
\begin{proof}
	...
	Por lo tanto $T$ es un árbol, y más aun, el orden de cada $f \in T$ es su dominio; como $2^{<\omega}$ contiene únicamente a todas las funciones de en $2$, se sigue que la altura de $T$ es $\omega = \sup\{ n+1 \tq n \in \omega \}$.
