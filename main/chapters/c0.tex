...
\begin{proposicion}
    ...
    \begin{enumerate}
        ...
        \item Si $A,B \subseteq C$ entonces $A \setminus B$ si y sólo si $A \setminus C$.
        \item $A \subseteq^* B$ si y sólo si existe un conjunto finito $F$ tal que $A \setminus F \subseteq B$.
    \end{enumerate}
\end{proposicion}
