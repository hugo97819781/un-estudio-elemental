...
\newcommand{\mycoloneq}{\mathrel{\text{\ooalign{\raisebox{0.5ex}{\scalebox{0.57}{$\bullet$}}\cr \raisebox{0.0ex}{\scalebox{0.57}{$\bullet$}}}}\mkern-5mu =}}
...
\newcommand{\lengua}{\ms{L}_{\operatorname{TC}}}
%COCIENTE
