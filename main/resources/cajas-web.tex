...
\mdfdefinestyle{caja5}{
	roundcorner=5pt,
	backgroundcolor=dorado!40,
	linewidth=0,
}
...
\declaretheorem[style=myTeoStyle,mdframed={style=caja5},name=Teorema,sharenumber=definicion]{teorema}
