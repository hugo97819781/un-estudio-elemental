...
Se finalizará la sección; y con ello el actual capítulo, dando un Corolario importante en relación a las imágenes continuas de los espacios de Mrówka pseudocompactos. Vale mencionar que el próximo Corolario aparece en \cite[Obs.~1.3-b), p.~6]{kannanHereditarily}, en tal artículo no se agrega la propiedad de Fréchet como hipótesis general; sin embargo, en este trabajo mostraremos la versión de este que sí la incluye.

\begin{corolario}
	Sea $X$ infinito, de Hausdorff y de Fréchet. Las siguientes condiciones son equivalentes:
	\begin{enumerate}[i)]
