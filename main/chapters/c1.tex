...
La familia $\ms{A} \upharpoonright Y$ provista por el Teorema de Simon es maximal e infinita necesariamente. Así que, tomando $\ms{A}$ como cualquier familia maximal infinita, se obtiene la siguiente consecuencia:
