...
De manera dual, un \textit{ideal} es un filtro en $(P,\geq)$. Un filtro (ideal, respectivamente) es \textit{propio} cuando es distinto de $P$.
\begin{proposicion}
