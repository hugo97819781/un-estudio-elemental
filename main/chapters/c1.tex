...
Un ejemplo canónico de árbol numerable de altura $\omega$ es $2^{<\omega}$ \textcolor{red}{(prelim)}; considerar la siguiente clase de familias desembocará en resultados sumamente notables (como se puede ver en la \cref{Sec-PDM}).
